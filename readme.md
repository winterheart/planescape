...
Помните, что версия EE может обновляться, а вместе с ней - оригинальные строки. Статус перевода и совместимость версий отображаются на странице перевода https://github.com/winterheart/planescape.
