# Planescape: Torment (EE), проект локализации
...
#### 1.05
* Поддерка Planescape: Torment Enhanced Edition: шрифт, изображения, текст. Перевод доступен в виде отдельного архива.
