...
from winterheart and tob1az http://pst-l10n.wikidot.com
...
**ВНИМАНИЕ!** Перед тем как установить данную локализацию, удостоверьтесь, что у вас установлен Planescape: Torment v. 1.1 + PS:T Ultimate WeiDU Fixpack 4.13. Ссылки на оба патча можно найти на той же странице, где вы скачали данную локализацию.

Скопируйте содержимое каталога в корень каталогов игры; при этом будут перезаписаны несколько файлов, на что, собственно, неплохо бы согласиться.
...
Локализация окончена, но все еще может содержать ошибки. Если вы нашли опечатки, "подлые" ошибки, искажающие смысл, и просто откровенные баги - пожалуйста, сообщите нам об этом через форум (в котором есть отдельная ветка "Ошибки перевода" - http://pst-l10n.wikidot.com/forum/c-25216/).
...
* [DLG] Патрульный Гармониума (dmhguard.dlg)
...
dpapuz2.dlg)
* [DLG] Стражник покоев Сандоза (dsguard.dlg)
...
* [DLG] Кузнец из Литейной (fsmith.dlg)
 ...
 * Труп 1146 из Морга, сожженый Игнусом (dz1146.dlg, dzm1146.dlg)
