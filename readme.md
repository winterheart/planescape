...
Скопируйте содержимое каталога в корень каталогов игры. После этого запустите setup-pst-l10n.bat. Если вы хотите также применить PS:T Ultimate WeiDU Fixpack, после установке перевода запустите Setup-PST-Fix.bat (порядок имеет значение).
